...
MainTile::MainTile(int damage, std::string& input_path_to_texture, bool is_wall,
                   float scale_size, bool is_finish)
  : damage_(damage)
...
AirTile::AirTile()
  : MainTile(default_tile_settings::air_tile_damage, 
             ...
             default_tile_settings::air_tile_is_finish)
{
...
FinishTile::FinishTile()
 :  MainTile(default_tile_settings::finish_tile_damage, 
             default_tile_settings::finish_tile_path_to_texture,
             default_tile_settings::finish_tile_is_wall,
             default_tile_settings::finish_tile_scale,
             default_tile_settings::finish_tile_is_finish)
{
InitTexture(default_tile_settings::finish_tile_upper_left_corner_x_coordinate,
            default_tile_settings::finish_tile_upper_left_corner_y_coordinate,
            default_tile_settings::finish_tile_size_tile_x_coordinate,
            default_tile_settings::finish_tile_size_tile_y_coordinate);
}
...
StoneTile::StoneTile()
  : MainTile(default_tile_settings::stone_tile_damage, 
             ...
             default_tile_settings::stone_tile_is_finish)
{
...
DamageTile::DamageTile()
  : MainTile(default_tile_settings::damage_tile_damage, 
             ...
             default_tile_settings::damage_tile_is_finish)
{
...
sf::Texture& MainTile::GetTexture() { return texture_; }
bool MainTile::IsFinish() { return is_finish_; }
